...
- 💻 [`dotfiles`](https://github.com/bphenriques/dotfiles) leveraging [Nix](https://nixos.org/) for reproducible systems including my personal homelab.
- 🗃️ [`selfhost-nix`](https://github.com/bphenriques/selfhost-nix) a NixOS framework supporting my homelab. Take a look!
